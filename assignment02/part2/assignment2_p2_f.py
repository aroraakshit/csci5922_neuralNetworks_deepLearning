...
def run():
    ...
    for i in [1,2,5,10,20]:
        ...
        print "Initializing weights and bias hidden unit:" + str(i)
        n = [5,i,1] #[number of input features, number of hidden units, number of output units]
        ...
        #training the neuron
        print "Training the neuron hidden unit:" + str(i)
